...
const SEND_GRID_KEY = "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"; // Add your key here
...
exports.postForgotPassword = async (req, res, next) => {
  ...
  try {
    ...
    const forgotEmail = {
      to: email,
      from: 'chavanpooja92241@gmail.com',
      subject: 'Here is your OTP to reset your Password',
      html: `<h1> OTP is: ${otp}</h1>
      <p> Enter this OTP on <a href="http://localhost:5173/reset-password?email=${email}">Reset Password</a> page. </p>
      `
    };
