...
const MONGO_DB_URL =
  `mongodb+srv://${process.env.MONGO_DB_USERNAME}chavanpooja92241:${process.env.MONGO_DB_PASSWORD}@airbnb.ic94j.mongodb.net/${process.env.MONGO_DB_DATABASE}?retryWrites=true&w=majority&appName=Airbnb`;
